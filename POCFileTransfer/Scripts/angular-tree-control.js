        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', function( $scope ) {
                    $scope.calcDragOverClass = function ($event, node) {
                        $scope.$parent.namer = node.path;
                   ...
                   // $scope.$apply(function () { $scope.files = 'xxx' });
                    ...
                    $scope.headClass = function(node) {
                        ...
                        if ($scope.options.isLeaf(node) && node.FileSize!=null)
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<li  ngf-drop ng-model="$parent.files"  ngf-drag-over-class="calcDragOverClass($event, node)" ngf-multiple="true" ngf-allow-dir="true" ng-repeat="node in node.' + $scope.options.nodeChildren + ' | filter:filterExpression:filterComparator ' + orderBy + '" ng-class="headClass(node)" ' + classIfDefined($scope.options.injectClasses.li, true) + '>' +
